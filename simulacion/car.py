import pygame
import random
from config import BLOCK_SIZE, STREET_WIDTH, CAR_SIZE, TURN_PROBABILITY, TRAFFIC_LIGHT_POSITIONS, INTERSECTION_MARGIN
...
class Car:
    ...
    def move(self, traffic_lights, column_directions, row_directions):
        if self.at_intersection(column_directions, row_directions, traffic_lights):
            ...
            if tli >= 0 and traffic_lights[tli].is_red():
                print('esperar')  # espera a que se ponga en verde.
            else:
